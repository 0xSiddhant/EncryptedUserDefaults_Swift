...
class AsymmetricUserDefaults {
    ...
    private let publicKeyTag = "YourAppPublicKey"
    private let privateKeyTag = "YourAppPrivateKey"
    ...
    private func encryptValue(_ value: Data) throws -> Data {
        ...
        return try SecKeyCreateEncryptedData(publicKey, .rsaEncryptionOAEPSHA512, value as CFData, nil)! as Data
    }
    ...
    private func decryptValue(_ encryptedData: Data) throws -> Data {
        ...
        return try SecKeyCreateDecryptedData(privateKey, .rsaEncryptionOAEPSHA512, encryptedData as CFData, nil)! as Data
    }
